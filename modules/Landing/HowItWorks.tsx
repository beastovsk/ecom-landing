...
const features: FeatureProps[] = [
  {
    ...
    description: 'Изучите наши тарифные планы и выберите интернет-магазин, который соответствует вашим требованиям.'
  },
  {
    icon: <MapIcon />,
    title: 'Оформление покупки',
    description: 'Заполните форму с вашими контактными данными и мы свяжемся с вами для уточнения подробностей.'
  },
  {
    icon: <PlaneIcon />,
