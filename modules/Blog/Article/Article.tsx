  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      ...
      <div className='mx-auto shadow-md rounded-lg overflow-hidden'>
        {/* Изображение статьи */}
        <Image src={blog.image} alt={blog.title} width={800} height={400} className='w-full h-[50vh] object-cover' />
        {/* Контент статьи */}
        <div className='p-6'>
          ...
          <div className='text-gray-700 leading-relaxed mt-4'>{htmlParser(blog.content)}</div>
        </div>
      </div>
    </div>
  );
